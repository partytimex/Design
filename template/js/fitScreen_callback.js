...
var getDeviceWidth_cssPixels = function(){
  ...
  if( Detector.isChrome ){
	  ...
	  alert(  deviceWidth_cssPixels );
	  if( Detector.isAndroid  ){deviceWidth_cssPixels = androidDeviceResolution / window.devicePixelRatio;alert( "androidDeviceResolution ="+androidDeviceResolution+" window.devicePixelRatio ="+window.devicePixelRatio + "deviceWidth_cssPixels="+deviceWidth_cssPixels);}
...
var getScale = function(){
  ...
  alert( "deviceWidth_cssPixels ="+deviceWidth_cssPixels+" scale ="+ scale );
  return scale;
